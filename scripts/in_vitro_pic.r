#################################################################
#								#
# Run PIC-seq on co-culture experiment (Figures 1 & 2)		#
#								#
#################################################################

message("Running PIC-seq on co-culture experiment (Figures 1 & 2)")
id = "in_vitro"
...
lin_ord = c("naive", "Anti-viral", "Tnf", "act", "Cycling",
	"3h", "mono", "Cst3", "coc",
	"NK", "Plasma", "contam")
...
mle_res = run_pic_seq(id_s, id_s, ds[,good_pics], t_cells, dc_cells,
...
sim_mle_res = assign_pics_to_singlets(id_s, id_s, sim_umis, t_cells, dc_cells, sim_alpha,
